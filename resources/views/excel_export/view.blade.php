                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <h5 class="fs-14 mb-0">{{date("d M Y", strtotime($export->date))}}</h5>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">BL No.</p>
                                        <h5 class="fs-14 mb-0">{{$export->bl_no}}</h5>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Container No.</p>
                                        <h5 class="fs-14 mb-0">{{$export->c_no}}</h5>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Ex Rate</p>
                                        <h5 class="fs-14 mb-0">{{number_format($export->conversion_rate, 3)}}</h5>
                                    </div>
                                        ...
                                        <table class="table table-bordered">
                                             ...
                                             <tfoot>
                                                 <tr class="table-active">
                                                     ...
                                                     <th class="text-end no-padding">{{number_format($export->cars->sum('price'))}}</th>
                                                     <th class="text-end no-padding">{{number_format($export->cars->sum('price_pkr'))}}</th>
                                                     <th ></th>
                                                 </tr>
                                             </tfoot>
                                        </table>
                                       ...
                                       <table class="table table-bordered">
                                            ...
                                            <tfoot>
                                                <tr class="table-active">
                                                    ...
                                                    <th class="text-end no-padding">{{number_format($export->parts->sum('qty'))}}</th>
                                                    <th class="text-end no-padding">{{number_format($export->parts->sum('price'))}}</th>
                                                    <th class="text-end no-padding">{{number_format($export->parts->sum('price_pkr'))}}</th>
                                                </tr>
                                            </tfoot>
                                       </table>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <h5 class="fs-14 mb-0">{{number_format($export->cars->sum('price'))}} | PKR {{number_format($export->cars->sum('price_pkr'))}}</h5>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Parts / Oil Total</p>
                                        <h5 class="fs-14 mb-0">{{number_format($export->parts->sum('price'))}} | PKR {{number_format($export->parts->sum('price_pkr'))}}</h5>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">BL Amount</p>
                                        <h5 class="fs-14 mb-0">{{number_format($export->bl_amount)}} | PKR {{number_format($export->bl_amount_pkr)}}</h5>
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Grand Total</p>
                                        <h5 class="fs-14 mb-0">{{number_format($export->cars->sum('price') + $export->parts->sum('price') + $export->bl_amount)}} | PKR {{number_format($export->cars->sum('price_pkr') + $export->parts->sum('price_pkr') + $export->bl_amount_pkr)}}</h5>
                                    </div>
