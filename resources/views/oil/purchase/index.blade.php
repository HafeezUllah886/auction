        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3>Oil Purchases</h3>
                    <button type="button" class="btn btn-primary" onclick="newWindow('{{route('oil_purchases.create')}}')">Create Purchase</button>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <button class="dropdown-item" onclick="newWindow('{{route('oil_purchases.show', $purchase->id)}}')"
                                                        onclick=""><i
                                                ...
                                                <li>
                                                    <a class="dropdown-item" onclick="newWindow('{{route('oil_purchases.edit', $purchase->id)}}')">
