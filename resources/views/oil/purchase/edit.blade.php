        ...
        <div class="col-12">
            <div class="card" id="demo">
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-6"><h3> Edit Oil Purchase </h3></div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('oil_purchases.update', $purchase->id) }}" method="post">
                        @csrf
                        @method("PUT")
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="products_list">
                                        ...
                                        <tr id="row_{{$id}}">
                                            ...
                                            <td class="no-padding">{{$product->product->ltr}}</td>
                                            <td class="no-padding">{{$product->product->grade}}</td>
                                            <td class="no-padding">{{$product->product->packing}}</td>
                                            <td class="no-padding"><input type="number" name="price[]" oninput="updateChanges({{$id}})" step="any" value="{{$product->price}}" min="1" class="form-control text-center no-padding" id="price_{{$id}}"></td>
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control" cols="30" rows="5">{{ $purchase->note }}</textarea>
                                </div>
                            </div>
                            <div class="col-12 mt-2">
